...
<title>Imposto de Porto Alegre</title>
</head>
<body>
	...
	<div align="center">
		<form action="PA" method="post">
			<table>
				<tr>
					<td><input type="number" min="0" id="areaTotal" name="areaTotal"
						placeholder="Área Total do Imóvel" required="required"></td>
				</tr>
				<tr>
					<td><input type="number" min="0" id="areaGaragem"
						name="areaGaragem" placeholder="Área da Garagem"
